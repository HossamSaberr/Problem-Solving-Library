...
void solve() {
    ...
    int l = 0, r = 3; // Get hash for substring "Hoss"
    cout << "Hash of substring \"" << s.substr(l, r - l + 1) << "\" is: " << hasher.get_hash(l, r) << endl;

    l = 1, r = 4; // Get hash for substring "ossa"
    cout << "Hash of substring \"" << s.substr(l, r - l + 1) << "\" is: " << hasher.get_hash(l, r) << endl;

    // Check if the substring is a palindrome
    if (hasher.get_hash(l, r) == hasher.rev_hash(l, r)) {
        cout << "The substring \"" << s.substr(l, r - l + 1) << "\" is a palindrome!\n";
    } else {
        cout << "The substring \"" << s.substr(l, r - l + 1) << "\" is not a palindrome.\n";
    }
}
